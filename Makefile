...
# Generated by qmake (2.01a) (Qt 4.6.2) on: ?r. mar 17 20:44:24 2010
# Project:  dicto.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/dicto1.0.0/ && $(COPY_FILE) --parents src/dialogs/about_dialog.h src/dialogs/wdialog.h src/dialogs/wprepare.h src/dialogs/wprint.h src/dialogs/wprops.h src/dialogs/wsettings.h src/mainwindow/wmain.h src/objects/cdocument.h src/objects/centry.h obj/dicto1.0.0/ && $(COPY_FILE) --parents resources/dicto.qrc obj/dicto1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/dialogs/about_dialog.cpp src/dialogs/wdialog.cpp src/dialogs/wprepare.cpp src/dialogs/wprint.cpp src/dialogs/wprops.cpp src/dialogs/wsettings.cpp src/mainwindow/wmain.cpp src/mainwindow/wmain_utils.cpp src/objects/cdocument.cpp src/objects/centry.cpp src/widgets/wmain_exam.cpp src/widgets/wmain_test.cpp obj/dicto1.0.0/ && $(COPY_FILE) --parents translations/dicto_pl.ts translations/dicto_ru.ts obj/dicto1.0.0/ && (cd `dirname obj/dicto1.0.0` && $(TAR) dicto1.0.0.tar dicto1.0.0 && $(COMPRESS) dicto1.0.0.tar) && $(MOVE) `dirname obj/dicto1.0.0`/dicto1.0.0.tar.gz . && $(DEL_FILE) -r obj/dicto1.0.0
...
compiler_moc_header_make_all: obj/moc_about_dialog.cpp obj/moc_wdialog.cpp obj/moc_wprepare.cpp obj/moc_wprint.cpp obj/moc_wprops.cpp obj/moc_wsettings.cpp obj/moc_wmain.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) obj/moc_about_dialog.cpp obj/moc_wdialog.cpp obj/moc_wprepare.cpp obj/moc_wprint.cpp obj/moc_wprops.cpp obj/moc_wsettings.cpp obj/moc_wmain.cpp
obj/moc_about_dialog.cpp: src/dialogs/about_dialog.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/dialogs/about_dialog.h -o obj/moc_about_dialog.cpp

obj/moc_wdialog.cpp: src/mainwindow/wmain.h \
		src/objects/cdocument.h \
		src/objects/centry.h \
		src/dialogs/wdialog.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/dialogs/wdialog.h -o obj/moc_wdialog.cpp

obj/moc_wprepare.cpp: src/dialogs/wprepare.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/dialogs/wprepare.h -o obj/moc_wprepare.cpp

obj/moc_wprint.cpp: src/dialogs/wprint.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/dialogs/wprint.h -o obj/moc_wprint.cpp

obj/moc_wprops.cpp: src/dialogs/wprops.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/dialogs/wprops.h -o obj/moc_wprops.cpp
...
obj/about_dialog.o: src/dialogs/about_dialog.cpp src/mainwindow/wmain.h \
		src/objects/cdocument.h \
		src/objects/centry.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/about_dialog.o src/dialogs/about_dialog.cpp

obj/wdialog.o: src/dialogs/wdialog.cpp src/dialogs/wdialog.h \
		src/mainwindow/wmain.h \
		src/objects/cdocument.h \
		src/objects/centry.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/wdialog.o src/dialogs/wdialog.cpp

obj/wprepare.o: src/dialogs/wprepare.cpp src/dialogs/wprepare.h \
		src/objects/cdocument.h \
		src/objects/centry.h \
		src/mainwindow/wmain.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/wprepare.o src/dialogs/wprepare.cpp
...
obj/wprops.o: src/dialogs/wprops.cpp src/dialogs/wprops.h \
		src/mainwindow/wmain.h \
		src/objects/cdocument.h \
		src/objects/centry.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/wprops.o src/dialogs/wprops.cpp
